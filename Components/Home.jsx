        ...
        <>
            <section className='iteam_section mt-2 container'>
                ...
                <div className="btn-container d-flex justify-content-around mt-2">
                    <button className="btn btn-danger" onClick={() => filteritems("Karnataka")}>Karnataka Special</button>
                    ...
                    <button className="btn btn-danger" onClick={() => filteritems("Chai")}>Special Chai</button>
                    <button className="btn btn-info" onClick={() => filteritems("French")}>French dishes</button>
                    <button className="btn btn-warning" onClick={() => setMenu(Fooddata)}>All dishes</button>
                </div>
